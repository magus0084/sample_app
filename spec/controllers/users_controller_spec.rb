  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
	  ...
	  response.should redirect_to(users_path)
       ...
       it "should not let the admin delete themselves" do
          lambda do
		delete :destroy, :id => @admin
	  end.should_not change(User, :count).by(-1) 
       end

       it "should not display the delete link for the admin" do
       	  get :index
	  response.should_not have_selector("a", :title => "Delete Admin")
       end

       it "should redirect to the users page on trying to delete onself" do
       	  delete :destroy, :id => @admin
	  response.should redirect_to(users_path)
       end
    end
