...
describe User do
   ...
   describe "password validations" do
	...
	it "should require a matching password confirmation" do
	   non_matching_confirmation_user = User.new(@attr.merge(:password_confirmation => "invalid"))
	   non_matching_confirmation_user.should_not be_valid
	end
   ...
   describe "password encryption" do
	    ...
	    describe "has_password? method" do
	       ...
	       it "should be false if the passwords don't match" do
	       	  @user.has_password?("invald").should be_false
	       end
	    end
	    ...
	    describe "authenticate method" do
		  ...
		  wrong_password_user.should be_nil
	       ...
	       it "should return nil if no user exists" do
	       	  non_existent_user = User.authenticate("guy@idontexist.com", @attr[:password])
		  non_existent_user.should be_nil
	       end

	       it "should return the user on success" do
	       	  existing_user = User.authenticate(@attr[:email], @attr[:password])
		  existing_user.should == @user
	       end
